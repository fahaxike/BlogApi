 ...
 * @LastEditTime: 2021-08-26 12:37:03
...
func loadServer() {
	...
	ReadTimeOut = time.Duration(Cfg.Section("READ_TIMEOUT").Key("READ_TIMEOUT").MustInt(60)) * time.Second
	WriteTimeOut = time.Duration(Cfg.Section("WRITE_TIMEOUT").Key("WRITE_TIMEOUT").MustInt(60)) * time.Second
